...
artist_table_create = (""" CREATE TABLE IF NOT EXISTS artists (artist_id varchar PRIMARY KEY, name varchar, location varchar  , latitude decimal , longitude decimal );""")
...
WHERE  artists.name=%s and title = %s  AND songs.duration = %s""")
